...
# NOTE: person outfit colors now come from the VLM stage (pipeline/vlm_attrs.py,
# vocab constrained in its prompt). The region-split SigLIP person-color stage and
# its PERSON_* knobs were removed — fixed crop fractions blended bystanders into
# wrong labels, and with margin 0 it never abstained.
